...
namespace Shop.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult<dynamic>> Get([FromServices] DataContext context)
        {
            ...
            var category = new Category { Id = 1, Title = "HQ" };
            var product = new Product { Id = 1, Category = category, Title = "Batman & Robin", Price = 30, Description = "HQ Adventures Batman and Robin" };
